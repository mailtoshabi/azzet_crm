                         ...
                         <tbody>
                            <?php $__currentLoopData = $estimates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estimate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('admin.estimates.edit',encrypt($estimate->id))); ?>" class=""><?php echo e($estimate->est_no); ?></a>
                                        <?php if($estimate->sale): ?>
                                        <br><small>Invoice No: <a href="<?php echo e(route('admin.sales.view',encrypt($estimate->sale->id))); ?>" class=""><?php echo e($estimate->sale->invoice_no); ?></a></small>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <a target="_blank" href="<?php echo e(route('admin.customers.view',encrypt($estimate->customer->id))); ?>"><?php echo e($estimate->customer->name. ' ' . $estimate->customer->city); ?></a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li><a class="dropdown-item" href="<?php echo e(route('admin.estimates.copy',encrypt($estimate->id))); ?>"><i class="fas fa-copy font-size-16 text-success me-1"></i> Creat a Copy</a></li>
                                                ...
                                                <form id="form_delete_<?php echo e($loop->iteration); ?>" method="POST" action="<?php echo e(route('admin.estimates.destroy',encrypt($estimate->id))); ?>">
                                                    ...
                                                    <?php if($estimate->products()->exists()): ?>
