...
<div class="row">
    <form method="POST" action="<?php echo e(isset($enquiry)? route('executive.enquiries.update') : route('executive.enquiries.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <p><a href="<?php echo e(route('executive.customers.create')); ?>"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;New <?php echo app('translator')->get('translation.Customer'); ?></a></p>
                            </div>
...
<?php echo $__env->make('admin.layouts.executive.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\azzet_crm\resources\views/admin/executive/enquiries/add.blade.php ENDPATH**/ ?>