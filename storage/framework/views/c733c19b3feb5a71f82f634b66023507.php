...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        <meta charset="utf-8" />
        <title> WBMAHALCRM - Customer Relationship Management Application</title>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="<?php echo e(route('admin')); ?>" class="underline text-gray-900 dark:text-white">Administrator Login</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Dashboard for Admin, Manager, HR
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="<?php echo e(route('executive')); ?>" class="underline text-gray-900 dark:text-white">Executive Login</a></div>
                            </div>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="mt-4 mt-md-5 text-center">
                            <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> WBMAHAL CRM.</p>
                        </div>
                    </div>

                    <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                        <div class="mt-4 mt-md-5 text-center">
                            <p class="mb-0">Crafted with <i class="mdi mdi-heart text-danger"></i> by <a target="_blank" href="https://webmahal.com">Web Mahal</a></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\azzet_crm\resources\views/welcome.blade.php ENDPATH**/ ?>