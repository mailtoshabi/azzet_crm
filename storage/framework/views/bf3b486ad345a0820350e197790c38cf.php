...
<div class="row">
    <form method="POST" action="<?php echo e(isset($product)? route('executive.products.update') : route('executive.products.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.executive.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\azzet_crm\resources\views\admin\executive\products\add.blade.php ENDPATH**/ ?>