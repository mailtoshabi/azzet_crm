    ...
    <div class="navbar-header">
            ...
            <div class="navbar-brand-box">
                <a href="index" class="logo logo-light branch_logo">
                    <span class="logo-lg">
                        ...
                        <?php else: ?>
                            <span class="logo-txt branch_logo_text"><?php echo e(Auth::guard('executive')->user()->branch->name); ?></span>
                        <?php endif; ?>
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="<?php if(Auth::guard('executive')->user()->avatar != ''): ?><?php echo e(URL::asset(App\Models\User::DIR_STORAGE . Auth::guard('executive')->user()->avatar)); ?><?php else: ?><?php echo e(URL::asset('images/avatar-1.jpg')); ?><?php endif; ?>" alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium"><?php echo e(Auth::guard('executive')->user()->name); ?></span>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <form id="logout-form" action="<?php echo e(route('executive.logout')); ?>" method="POST" style="display: none;">
                        <?php echo csrf_field(); ?>
                    </form>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\azzet_crm\resources\views/admin/layouts/executive/topbar.blade.php ENDPATH**/ ?>