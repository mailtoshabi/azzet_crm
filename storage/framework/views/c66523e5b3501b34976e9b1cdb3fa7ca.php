...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
          <a class="nav-link <?php if($is_approved==Utility::ITEM_INACTIVE): ?> active <?php endif; ?>" <?php if($is_approved==Utility::ITEM_INACTIVE): ?>aria-current="page"<?php endif; ?> href="<?php echo e(route('admin.products.index','status='.encrypt(Utility::ITEM_INACTIVE))); ?>">Pending <span class="badge rounded-pill bg-soft-danger text-danger float-end"><?php echo e($count_new); ?></span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php if($is_approved==Utility::ITEM_ACTIVE): ?> active <?php endif; ?>" <?php if($is_approved==Utility::ITEM_ACTIVE): ?>aria-current="page"<?php endif; ?> href="<?php echo e(route('admin.products.index','status='.encrypt(Utility::ITEM_ACTIVE))); ?>">Approved</a>
        </li>
      </ul>
    </div>
</div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\azzet_crm\resources\views\admin\products\index.blade.php ENDPATH**/ ?>