        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="card-title-desc"><?php echo e(isset($customer)? 'Edit' : "Enter"); ?> the Details of your Customer</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="building_no" name="building_no" type="text" class="form-control"  placeholder="Building Number" value="<?php echo e(isset($customer)?$customer->building_no:old('building_no')); ?>">
                                
                            </div>
                            <div class="mb-3">
                                <label for="street">Street</label>
                                <input id="street" name="street" type="text" class="form-control"  placeholder="Street" value="<?php echo e(isset($customer)?$customer->street:old('street')); ?>">
