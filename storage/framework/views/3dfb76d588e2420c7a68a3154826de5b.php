...
<div class="row">
    <form method="POST" action="<?php echo e(isset($customer)? route('employee.customers.update') : route('employee.customers.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<script>
    ...
    function getdistrict(val) {
        $.ajax({
            type: "POST",
            url: "<?php echo e(route('employee.customers.list.districts')); ?>",
            data:'state_id='+val,
...
<?php echo $__env->make('admin.layouts.employee.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\azzet_crm\resources\views\admin\employee\customers\add.blade.php ENDPATH**/ ?>