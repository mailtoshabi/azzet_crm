        ...
        <table cellpadding="0" cellspacing="0"  class="w-full">
            <tr>
                <td class="w-half">
                    <table class="w-full">
                        <tr class="left">
                            <td class="w-quarter has-border"><img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('storage/branches/' . $sale->estimate->branch->image)))); ?>" class="w-full" style="background-color: black;" ></td>
