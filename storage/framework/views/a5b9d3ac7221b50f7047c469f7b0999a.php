                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mt-2">Reset Password with WBMAHALCRM.</p>
                                </div>
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" id="input-email" placeholder="Enter Email">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> WBMAHALCRM   . Crafted with <i class="mdi mdi-heart text-danger"></i> by WebMahal.com</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\azzet_crm\resources\views\admin\auth\passwords\email.blade.php ENDPATH**/ ?>