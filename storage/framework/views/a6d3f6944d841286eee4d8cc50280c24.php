                    ...
                    <div class="w-100">
                        <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <p class="text-muted mb-0">Already have an account ? <a href="<?php echo e(route('seller.login')); ?>" class="text-primary fw-semibold"> Sign in here </a> </p>
                                            </div>
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <select class="form-select" id="bank_id" name="bank_id">
                                                                                    ...
                                                                                    <option value="<?php echo e($bank->id); ?>"><?php echo e($bank->name_en); ?></option>
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Dason   . Crafted with <i class="mdi mdi-heart text-danger"></i> by WebMahal.com</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.executive.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\azzet_crm\resources\views\admin\executive\auth\register.blade.php ENDPATH**/ ?>