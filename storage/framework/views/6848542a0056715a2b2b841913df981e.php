...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
          <a class="nav-link <?php if($is_approved==Utility::ITEM_INACTIVE): ?> active <?php endif; ?>" <?php if($is_approved==Utility::ITEM_INACTIVE): ?>aria-current="page"<?php endif; ?> href="<?php echo e(route('employee.customers.index','status='.encrypt(Utility::ITEM_INACTIVE))); ?>">Pending <span class="badge rounded-pill bg-soft-danger text-danger float-end"><?php echo e($count_new); ?></span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php if($is_approved==Utility::ITEM_ACTIVE): ?> active <?php endif; ?>" <?php if($is_approved==Utility::ITEM_ACTIVE): ?>aria-current="page"<?php endif; ?> href="<?php echo e(route('employee.customers.index','status='.encrypt(Utility::ITEM_ACTIVE))); ?>">Approved</a>
        </li>
      </ul>
    </div>
</div>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li><a class="dropdown-item" href="<?php echo e(route('employee.customers.edit',encrypt($customer->id))); ?>"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Edit</a></li>
                                                        ...
                                                        <form id="form_delete_<?php echo e($loop->iteration); ?>" method="POST" action="<?php echo e(route('employee.customers.destroy',encrypt($customer->id))); ?>">
                                                            <?php echo csrf_field(); ?>
                                                            <input type="hidden" name="_method" value="DELETE" />
                                                        </form>
                                                        <?php endif; ?>
                                                        <li><a class="dropdown-item" href="<?php echo e(route('employee.customers.view',encrypt($customer->id))); ?>"><i class="fa fa-eye font-size-16 text-success me-1"></i> Details</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                       </tr>
...
<?php echo $__env->make('admin.layouts.employee.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\azzet_crm\resources\views\admin\employee\customers\index.blade.php ENDPATH**/ ?>