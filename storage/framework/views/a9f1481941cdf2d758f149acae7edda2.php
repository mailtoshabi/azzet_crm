...
<div class="row">
    <form method="POST" action="<?php echo e(isset($product)? route('admin.products.update') : route('admin.products.store')); ?>" enctype="multipart/form-data">
        ...
        <?php if(isset($product)): ?>
            <input type="hidden" name="category_id" value="<?php echo e(encrypt($product->id)); ?>" />
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex flex-wrap gap-2">
                        <button type="submit" class="btn btn-primary waves-effect waves-light"><?php echo e(isset($product) ? 'Update' : 'Add New'); ?></button>
