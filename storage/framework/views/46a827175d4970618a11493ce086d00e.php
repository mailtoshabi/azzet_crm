...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
          <a class="nav-link <?php if($is_approved==Utility::ITEM_INACTIVE): ?> active <?php endif; ?>" <?php if($is_approved==Utility::ITEM_INACTIVE): ?>aria-current="page"<?php endif; ?> href="<?php echo e(route('employee.enquiries.index','status='.encrypt(Utility::ITEM_INACTIVE))); ?>">Pending <span class="badge rounded-pill bg-soft-danger text-danger float-end"><?php echo e($count_new); ?></span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php if($is_approved==Utility::ITEM_ACTIVE): ?> active <?php endif; ?>" <?php if($is_approved==Utility::ITEM_ACTIVE): ?>aria-current="page"<?php endif; ?> href="<?php echo e(route('employee.enquiries.index','status='.encrypt(Utility::ITEM_ACTIVE))); ?>">Approved</a>
        </li>
      </ul>
    </div>
</div>
                 ...
                 <div class="row align-items-center">
                     ...
                     <div class="col-md-6">
                         <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                             ...
                             <div>
                                 <a href="<?php echo e(route('employee.enquiries.create')); ?>" class="btn btn-light"><i class="bx bx-plus me-1"></i> Add New Enquiry</a>
                             </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><a class="dropdown-item" href="<?php echo e(route('employee.enquiries.edit',encrypt($enquiry->id))); ?>"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Edit</a></li>
                                                ...
                                                <form id="form_delete_<?php echo e($loop->iteration); ?>" method="POST" action="<?php echo e(route('employee.enquiries.destroy',encrypt($enquiry->id))); ?>">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.employee.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\azzet_crm\resources\views\admin\employee\enquiries\index.blade.php ENDPATH**/ ?>