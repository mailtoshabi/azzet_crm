...
<div class="row">
    <form method="POST" action="<?php echo e(isset($product)? route('employee.products.update') : route('employee.products.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.employee.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\azzet_crm\resources\views\admin\employee\products\add.blade.php ENDPATH**/ ?>