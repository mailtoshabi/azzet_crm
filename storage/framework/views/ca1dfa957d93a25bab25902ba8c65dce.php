...
class LaravelEntrustSeeder extends Seeder
{
        ...
        foreach ($config as $key => $modules) {
            ...
            if(isset($userRoles[$key])) {
                ...
                foreach ($role_users as $role_user) {
                    ...
                    $user = \<?php echo e($user); ?>::create($role_user);
    ...
    public function truncateEntrustTables()
    {
        ...
        DB::table('<?php echo e(config('entrust.tables.permission_role')); ?>')->truncate();
        DB::table('<?php echo e(config('entrust.tables.role_user')); ?>')->truncate();
        DB::table('<?php echo e(config('entrust.user_table')); ?>')->truncate();

        \<?php echo e(config('entrust.models.role')); ?>::truncate();
        \<?php echo e(config('entrust.models.permission')); ?>::truncate();

        Schema::enableForeignKeyConstraints();
    }
}<?php /**PATH C:\xampp\htdocs\azzet_crm\vendor\shanmuga\laravel-entrust\src\resources\views\seeder.blade.php ENDPATH**/ ?>