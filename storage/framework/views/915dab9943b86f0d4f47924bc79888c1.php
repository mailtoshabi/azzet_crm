...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link <?php if($status==Utility::STATUS_OUT): ?> active <?php endif; ?>" <?php if($status==Utility::STATUS_OUT): ?>aria-current="page"<?php endif; ?> href="<?php echo e(route('employee.sales.index','status='.encrypt(Utility::STATUS_OUT))); ?>">Out for Delivery <?php echo sales_exe_count(Utility::STATUS_OUT); ?></a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?php if($status==Utility::STATUS_DELIVERED): ?> active <?php endif; ?>" <?php if($status==Utility::STATUS_DELIVERED): ?>aria-current="page"<?php endif; ?> href="<?php echo e(route('employee.sales.index','status='.encrypt(Utility::STATUS_DELIVERED))); ?>">Delivered <?php echo sales_exe_count(Utility::STATUS_DELIVERED); ?></a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?php if($status==Utility::STATUS_ONHOLD): ?> active <?php endif; ?>" <?php if($status==Utility::STATUS_ONHOLD): ?>aria-current="page"<?php endif; ?> href="<?php echo e(route('employee.sales.index','status='.encrypt(Utility::STATUS_ONHOLD))); ?>">On Hold <?php echo sales_exe_count(Utility::STATUS_ONHOLD); ?></a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?php if($status==Utility::STATUS_CANCELLED): ?> active <?php endif; ?>" <?php if($status==Utility::STATUS_CANCELLED): ?>aria-current="page"<?php endif; ?> href="<?php echo e(route('employee.sales.index','status='.encrypt(Utility::STATUS_CANCELLED))); ?>">Cancelled</a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?php if($status==Utility::STATUS_CLOSED): ?> active <?php endif; ?>" <?php if($status==Utility::STATUS_CLOSED): ?>aria-current="page"<?php endif; ?> href="<?php echo e(route('employee.sales.index','status='.encrypt(Utility::STATUS_CLOSED))); ?>">Closed</a>
        </li>
        <li class="nav-item">
