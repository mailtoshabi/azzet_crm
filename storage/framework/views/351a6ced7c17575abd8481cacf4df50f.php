<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Add_Employee'); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->slot('title'); ?> <?php if(isset($employee)): ?> <?php echo app('translator')->get('translation.Edit_Employee'); ?> <?php else: ?> <?php echo app('translator')->get('translation.Add_Employee'); ?> <?php endif; ?> <?php $__env->endSlot(); ?>
<?php echo $__env->renderComponent(); ?>
<div class="row">
    <form method="POST" action="<?php echo e(isset($employee)? route('admin.employees.update') : route('admin.employees.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <?php if(isset($employee)): ?>
            <input type="hidden" name="employee_id" value="<?php echo e(encrypt($employee->id)); ?>" />
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3 required">
                                ...
                                <input id="name" name="name" type="text" class="form-control"  placeholder="Name" value="<?php echo e(isset($employee)?$employee->name:old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 required">
                                ...
                                <input id="city" name="city" type="text" class="form-control" placeholder="Place" value="<?php echo e(isset($employee)?$employee->city:old('city')); ?>">
                                <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 required">
                                ...
                                <input id="postal_code" name="postal_code" type="text" class="form-control"  placeholder="Postal Code" value="<?php echo e(isset($employee)?$employee->postal_code:old('postal_code')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <span id="imageContainer" <?php if(isset($employee)&&empty($employee->image)): ?> style="display: none" <?php endif; ?>>
                                    <?php if(isset($employee)&&!empty($employee->image)): ?>
                                        <img src="<?php echo e(URL::asset(App\Models\Branch::DIR_STORAGE . $employee->image)); ?>" alt="" class="avatar-xxl rounded-circle me-2">
                                        <button type="button" class="btn-close" aria-label="Close"></button>
                                    <?php endif; ?>
                                </span>

                                <span id="fileContainer" <?php if(isset($employee)&&!empty($employee->image)): ?> style="display: none" <?php endif; ?>>
...
<script>
    $(document).ready(function() {
        <?php if(isset($employee)): ?>
            getdistrict(<?php echo e(Utility::STATE_ID_KERALA); ?>,<?php echo e($employee->district_id); ?>);
        <?php else: ?>
    ...
    function getdistrict(val,d_id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(route('admin.employees.list.districts')); ?>",
            data:formData,
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\azzet_crm\resources\views\admin\employees\add.blade.php ENDPATH**/ ?>