...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Settings::create(['term'=>'name', 'value'=>'Azzet Group']);
        Settings::create(['term'=>'trade_name', 'value'=>'Azzet Group']);
        Settings::create(['term'=>'email', 'value'=>'azzetgroup@gmail.com']);
        ...
        Settings::create(['term'=>'website', 'value'=>'www.azzetgroup.com']);
        Settings::create(['term'=>'gstin', 'value'=>'32ABWFA6262D1ZF']);
