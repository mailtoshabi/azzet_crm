                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="trade_name" name="trade_name" type="text" class="form-control"  placeholder="@lang('translation.Trade_Name')" value="{{ isset($branch)?$branch->trade_name:old('trade_name')}}">
