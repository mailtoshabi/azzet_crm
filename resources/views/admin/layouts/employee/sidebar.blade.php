            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li class="{{ set_active(['employee.enquiries.edit','employee.enquiries.view']) }}"><a href="{{ route('employee.enquiries.index') }}" data-key="t-read-email">@lang('translation.Enquiry_List')</a></li>
                        <li><a href="{{ route('employee.enquiries.create') }}" data-key="t-inbox">@lang('translation.Add_Menu')</a></li>

                    </ul>
                </li>

                <li class="{{ set_active(['employee.sales.view']) }}">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('employee.products.create') }}" data-key="t-inbox">@lang('translation.Add_Menu')</a></li>
                        <li class="{{ set_active('employee.products.edit') }}"><a href="{{ route('employee.products.index') }}" data-key="t-read-email">@lang('translation.List_Menu')</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li class="{{ set_active(['employee.customers.edit','employee.customers.view']) }}"><a href="{{ route('employee.customers.index') }}" data-key="t-read-email">@lang('translation.Customer_List')</a></li>
                        <li><a href="{{ route('employee.customers.create') }}" data-key="t-inbox">@lang('translation.Add_Menu')</a></li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        ...
                        <span data-key="t-email">@lang('translation.EmployeeReport_Manage')</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li class="{{ set_active(['employee.employee_reports.edit']) }}"><a href="{{ route('employee.employee_reports.index') }}" data-key="t-read-email">@lang('translation.EmployeeReport_List')</a></li>
                        <li><a href="{{ route('employee.employee_reports.create') }}" data-key="t-inbox">@lang('translation.Add_Menu')</a></li>
