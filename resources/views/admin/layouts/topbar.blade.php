            ...
            <div class="dropdown d-none d-lg-inline-block ms-1">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end top_bar">
                    <div class="p-2">
                        <div class="row g-0">
                            <div class="col">
                                <a class="dropdown-icon-item" href="{{ route('admin.enquiries.create') }}">
                                    <i class="fas fa-binoculars"></i>
                                    <span>Enquiry</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="{{ route('admin.estimates.create') }}">
                                    <i class="fas fa-clipboard"></i>
                                    <span>Estimate</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="{{ route('admin.sales.index') }}">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col">
                                <a class="dropdown-icon-item" href="{{ route('admin.executives.create') }}">
