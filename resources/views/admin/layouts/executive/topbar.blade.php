    ...
    <div class="navbar-header">
            ...
            <div class="navbar-brand-box">
                <a href="#" class="logo logo-light branch_logo">
                    <span class="logo-lg">
                        ...
                        @else
                            <span class="logo-txt branch_logo_text">{{ Auth::guard('executive')->user()->branch->name }}</span>
                        @endif
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-none d-lg-inline-block ms-1">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    <div class="p-2">
                        <div class="row g-0">
                            <div class="col">
                                <a class="dropdown-icon-item" href="{{ route('executive.enquiries.create') }}">
                                    <i class="fas fa-binoculars"></i>
                                    <span>Enquiry</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="{{ route('executive.products.create') }}">
                                    <i class="fas fa-boxes"></i>
                                    <span>Products</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="{{ route('executive.customers.create') }}">
            ...
            <div class="dropdown d-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="@if (Auth::guard('executive')->user()->avatar != ''){{ URL::asset(App\Models\User::DIR_STORAGE . Auth::guard('executive')->user()->avatar) }}@else{{ URL::asset('images/avatar-1.jpg') }}@endif" alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium">{{ Auth::guard('executive')->user()->name }}</span>
