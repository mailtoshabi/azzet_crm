...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
          <a class="nav-link @if($is_approved==0) active @endif" @if($is_approved==0)aria-current="page"@endif href="{{ route('executive.enquiries.index','status='.encrypt(0)) }}">Pending</a>
        </li>
        <li class="nav-item">
