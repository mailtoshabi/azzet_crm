...
@endcomponent
<div class="row">
    <form method="POST" action="{{ isset($customer)? route('executive.customers.update') : route('executive.customers.store')  }}" enctype="multipart/form-data">
        @csrf
        @if (isset($customer))
...
<script>
    ...
    function getdistrict(val) {
        $.ajax({
            type: "POST",
            url: "{{ route('executive.customers.list.districts') }}",
            data:'state_id='+val,
