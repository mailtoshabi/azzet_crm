...
@endcomponent
<div class="row">
    <form method="POST" action="{{ isset($enquiry)? route('employee.enquiries.update') : route('employee.enquiries.store')  }}" enctype="multipart/form-data">
        @csrf
        @if (isset($enquiry))
                ...
                <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p><a href="{{ route('employee.customers.create') }}"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;New @lang('translation.Customer')</a></p>
                            </div>
