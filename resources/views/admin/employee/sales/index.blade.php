...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link @if($status==Utility::STATUS_OUT) active @endif" @if($status==Utility::STATUS_OUT)aria-current="page"@endif href="{{ route('employee.sales.index','status='.encrypt(Utility::STATUS_OUT)) }}">Out for Delivery {!! sales_exe_count(Utility::STATUS_OUT) !!}</a>
        </li>
        <li class="nav-item">
            <a class="nav-link @if($status==Utility::STATUS_DELIVERED) active @endif" @if($status==Utility::STATUS_DELIVERED)aria-current="page"@endif href="{{ route('employee.sales.index','status='.encrypt(Utility::STATUS_DELIVERED)) }}">Delivered {!! sales_exe_count(Utility::STATUS_DELIVERED) !!}</a>
        </li>
        <li class="nav-item">
            <a class="nav-link @if($status==Utility::STATUS_ONHOLD) active @endif" @if($status==Utility::STATUS_ONHOLD)aria-current="page"@endif href="{{ route('employee.sales.index','status='.encrypt(Utility::STATUS_ONHOLD)) }}">On Hold {!! sales_exe_count(Utility::STATUS_ONHOLD) !!}</a>
        </li>
        <li class="nav-item">
            <a class="nav-link @if($status==Utility::STATUS_CANCELLED) active @endif" @if($status==Utility::STATUS_CANCELLED)aria-current="page"@endif href="{{ route('employee.sales.index','status='.encrypt(Utility::STATUS_CANCELLED)) }}">Cancelled</a>
        </li>
        <li class="nav-item">
