                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 azzet_invoice">
                        ...
                        <div class="mt-4">
                            ...
                            <a data-plugin="confirm-data" data-confirmtext="Do you really want to print the Invoice?" href="{{ route('employee.sales.view.invoice',encrypt($sale->id)) }}" class="btn btn-secondary waves-effect waves-light w-sm">
