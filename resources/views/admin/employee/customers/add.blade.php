...
@endcomponent
<div class="row">
    <form method="POST" action="{{ isset($customer)? route('employee.customers.update') : route('employee.customers.store')  }}" enctype="multipart/form-data">
        @csrf
        @if (isset($customer))
...
<script>
    ...
    function getdistrict(val) {
        $.ajax({
            type: "POST",
            url: "{{ route('employee.customers.list.districts') }}",
            data:'state_id='+val,
