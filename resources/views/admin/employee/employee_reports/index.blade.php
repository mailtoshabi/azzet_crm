...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link @if($status==Utility::ITEM_ACTIVE) active @endif" @if($status==Utility::ITEM_ACTIVE)aria-current="page"@endif href="{{ route('employee.employee_reports.index','status='.encrypt(Utility::ITEM_ACTIVE)) }}">Recent <span class="badge rounded-pill bg-soft-danger text-danger float-end">{{ $count_new }}</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link @if($status==Utility::ITEM_INACTIVE) active @endif" @if($status==Utility::ITEM_INACTIVE)aria-current="page"@endif href="{{ route('employee.employee_reports.index','status='.encrypt(Utility::ITEM_INACTIVE)) }}">History</a>
          </li>
      </ul>
    </div>
</div>
                 ...
                 <div class="row align-items-center">
                     ...
                     <div class="col-md-6">
                         <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                             ...
                             <div>
                                 <a href="{{ route('employee.employee_reports.create') }}" class="btn btn-light"><i class="bx bx-plus me-1"></i> Add New</a>
                             </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                {{-- <li><a class="dropdown-item" href="{{ route('employee.employee_reports.changeStatus',encrypt($employee_report->id))}}">{!! $employee_report->status?'<i class="fas fa-power-off font-size-16 text-danger me-1"></i> Unpublish':'<i class="fas fa-circle-notch font-size-16 text-primary me-1"></i> Publish'!!}</a></li> --}}
                                            </ul>
                                        </div>
                                    </td>
                                    @endif
