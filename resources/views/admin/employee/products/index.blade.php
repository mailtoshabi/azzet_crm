...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
          <a class="nav-link @if($is_approved==Utility::ITEM_INACTIVE) active @endif" @if($is_approved==Utility::ITEM_INACTIVE)aria-current="page"@endif href="{{ route('employee.products.index','status='.encrypt(Utility::ITEM_INACTIVE)) }}">Pending <span class="badge rounded-pill bg-soft-danger text-danger float-end">{{ $count_new }}</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link @if($is_approved==Utility::ITEM_ACTIVE) active @endif" @if($is_approved==Utility::ITEM_ACTIVE)aria-current="page"@endif href="{{ route('employee.products.index','status='.encrypt(Utility::ITEM_ACTIVE)) }}">Approved</a>
        </li>
      </ul>
    </div>
</div>
                 ...
                 <div class="row align-items-center">
                     ...
                     <div class="col-md-6">
                         <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                             ...
                             <div>
                                 <a href="{{ route('employee.products.create') }}" class="btn btn-light"><i class="bx bx-plus me-1"></i> Add New Product</a>
                             </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li><a class="dropdown-item" href="{{ route('employee.products.edit',encrypt($product->id))}}"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Edit</a></li>
                                                ...
                                                <form id="form_delete_{{ $loop->iteration }}" method="POST" action="{{ route('employee.products.destroy',encrypt($product->id))}}">
                                                    @csrf
